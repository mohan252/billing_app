...
ALTER TABLE [dbo].[DEBIT_NOTE_ITEMS]  WITH CHECK ADD  CONSTRAINT [FK_DEBIT_NOTE_ITEMS_DEBIT_NOTE] FOREIGN KEY([DEBITNOTENO],[ADDRESS])
REFERENCES [dbo].[DEBIT_NOTE] ([NO], [ADDRESS])
GO
